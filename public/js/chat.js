    ...
    socket.onmessage = function(e) {
        ...
        if(data.type == 'server') {
            switch(data.info) {
                ...
                case 'success':
                    document.getElementById('send').childNodes[0].nodeValue = 'Gönder';
                    updateBar('mdi-content-send', 'Mesajınızı buraya yazın', false);
                    connected = true;
                ...
                case 'connection':
                    ...
                    showChat('info', null, data.user.un + userip + ' sunucuya yeniden bağlandı.');

                    clients[data.user.id] = data.user;
                    document.getElementById('users').innerHTML = Object.keys(clients).length + ' Kullanıcı';
                    break;
                ...
                case 'disconnection':
                    ...
                    if(data.user.un != null) {
                        showChat('info', null, data.user.un + userip + ' sunucudan çıktı.');
                    }
